    ...
    <>
      <div className="  xl:flex xl:flex-col xl:justify-between xl:items-center ">
        ...
        <div className="w-screen h-auto bg-[url(/gradientImage.png)] bg-cover bg-no-repeat border-2">
          ...
          <div className="flex flex-col justify-between items-center xl:my-8 xl:py-0 py-8 px-1.5 gap-1.5 xl:max-w-64.5 mx-auto border-2 ">
          ...
          <p className="heading3 xl:max-w-64.5 my-8 px-1.5 mx-auto border-2">
