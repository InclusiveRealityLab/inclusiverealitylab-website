...
function CategoryContainer({ category, people }) {
  ...
  return (
    < >{people && (
      ...
      <p className="heading4">{category === "Lab" ? "Lab members" : category === "Collaborator" ? "Collaborators" : category}</p>
      ...
      {category.toLowerCase() === "lab" && (
        <>
          ...
          <div className="flex flex-row flex-wrap w-full gap-x-peopleGutter  ">
