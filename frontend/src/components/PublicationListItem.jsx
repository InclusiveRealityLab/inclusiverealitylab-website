function PublicationListItem({ publication }) {
  return (
    <div className="flex xl:flex-row-reverse flex-col justify-between items-stretch xl:w-full xl:max-w-64.5 xl:h-12.5 flex-grow basis-17 max-w-25 xl:basis-0  xl:gap-2 gap-1 border-1 border-blue-500 ">
      <img
      ...
      <div className="flex flex-col items-start xl:justify-between justify-between pb-0.5 xl:pt-1 xl:pb-1 xl:gap-1.5  gap-1.5  ">
        <div className="flex flex-col items-start xl:gap-0.5 gap-0.5">
          <p className="flex bodySmall">
            {publication?.conference ?? "CHI2024"}
          </p>

          <p className="bodyBigBold overflow-hidden text-ellipsis line-clamp-2  border-1 border-pink-500">
            {publication?.title ??
